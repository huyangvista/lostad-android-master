...
//			} 
    ...
    public void toMainActivty() {
        toActivtyClear(MainActivity.class);
    }
    public void toLoginActivty() {
        toActivty(LoginActivity.class);
    }
    public void toActivty(Class activityClass) {
        ContextUtil.toActivty(this, activityClass);
    }
    public void toActivtyClear(Class activityClass) {
        ContextUtil.toActivtyClear(this, activityClass);
    }
    public void toActivty(Map<String, ? extends Serializable> params, Class activityClass) {
        ContextUtil.toActivty(this,params, activityClass);
    }
    public void toActivtyClear(Map<String, ? extends Serializable> params, Class activityClass) {
        ContextUtil.toActivtyClear(this,params, activityClass);
    }
     ...
     * @param activityClass
     */
    public void toActivtyResult(Map<String, ? extends Serializable> params, Class activityClass) {
        ContextUtil.toActivtyResult(this, params,activityClass);
    }
