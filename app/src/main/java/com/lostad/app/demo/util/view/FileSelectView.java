...
public class FileSelectView extends ListView implements AdapterView.OnItemClickListener {
    ...
    public FileSelectView(Context context, int dialogid, CallbackBundle callback, String suffix, Map<String, Integer> images, String defPath) {
        super(context);
        this.imagemap = images;
        this.suffix = suffix==null?"":suffix.toLowerCase();
        this.callback = callback;
    ...
    private int refreshFileList()
    {
        ...
        SimpleAdapter adapter = new SimpleAdapter(getContext(), list, R.layout.activity_folder_select_item, new String[]{"img", "name", "path"}, new int[]{R.id.filedialogitem_img, R.id.filedialogitem_name, R.id.filedialogitem_path});
